...
namespace opdracht2.Controllers
{
    public class PokemonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Cost,Picture")] Pokemon pokemon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Cost,Picture")] Pokemon pokemon)
        {
            if (id != pokemon.Id)
            {
                return NotFound();
